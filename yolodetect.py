...
class YoloDetect():
    def __init__(self, detect_class="person", frame_width=1280, frame_height=720):
        # Parameters
        self.classnames_file = "C:/Users/HoPhucTrang/Desktop/track_king/yolov5/Yolov5_DeepSort_Pytorch/yolov5/IW/MiAI_Intrusion_Warning/model/classnames.txt"
        self.weights_file =    "C:/Users/HoPhucTrang/Desktop/track_king/yolov5/Yolov5_DeepSort_Pytorch/yolov5/IW/MiAI_Intrusion_Warning/model/yolov4-tiny.weights"
        self.config_file =     "C:/Users/HoPhucTrang/Desktop/track_king/yolov5/Yolov5_DeepSort_Pytorch/yolov5/IW/MiAI_Intrusion_Warning/model/yolov4-tiny.cfg"
    ...
    def alert(self, img):
        cv2.putText(img, "Nguy hiểm !!!", (10, 50), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2)
